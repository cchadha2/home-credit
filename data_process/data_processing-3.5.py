...
def cc_balance(df):
    ...
    credit_card_balance['AMT_DRAWINGS'] = (credit_card_balance['AMT_DRAWINGS_ATM_CURRENT'] + credit_card_balance['AMT_DRAWINGS_CURRENT'] +
                                           credit_card_balance['AMT_DRAWINGS_OTHER_CURRENT'] + credit_card_balance['AMT_DRAWINGS_POS_CURRENT'])
...
def installments(df):
    ...
    ins['EARLY_INSTALMENT_PAST_DUE_5'] = 0
    ins.loc[:,'EARLY_INSTALMENT_PAST_DUE_5'][(ins['NUM_INSTALMENT_NUMBER'] <= 5) & (ins['DUE_DATE_DIFF'] > 3)]  = 1
    ins['EARLY_INSTALMENT_BEFORE_DUE_5'] = 0
    ins.loc[:,'EARLY_INSTALMENT_BEFORE_DUE_5'][(ins['NUM_INSTALMENT_NUMBER'] <= 5) & (ins['DUE_DATE_DIFF'] > 3)]  = 1
    ins['EARLY_INSTALMENT_PAST_DUE_10'] = 0
    ins.loc[:,'EARLY_INSTALMENT_PAST_DUE_10'][(ins['NUM_INSTALMENT_NUMBER'] <= 10) & (ins['DUE_DATE_DIFF'] > 5)]  = 1
    ins['EARLY_INSTALMENT_BEFORE_DUE_10'] = 0
    ins.loc[:,'EARLY_INSTALMENT_BEFORE_DUE_10'][(ins['NUM_INSTALMENT_NUMBER'] <= 10) & (ins['DUE_DATE_DIFF'] > 5)]  = 1
...
def pos_cash(df):
    ...
    pos_first_late_30 = pos_first_late[((pos_first_late['SK_DPD'] >= 30) & (pos_first_late['SK_DPD'] <= 60))  | ((pos_first_late['SK_DPD_DEF'] >= 30) & (pos_first_late['SK_DPD_DEF'] <= 60)) ].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})
    pos_first_late_30_large = pos_first_late[((pos_first_late['SK_DPD_DEF'] >= 30) & (pos_first_late['SK_DPD_DEF'] <= 60))].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})
    
    pos_first_late_60 = pos_first_late[((pos_first_late['SK_DPD'] >= 60) & (pos_first_late['SK_DPD'] <= 90))  | ((pos_first_late['SK_DPD_DEF'] >= 60) & (pos_first_late['SK_DPD_DEF'] <= 90))].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})
    pos_first_late_60_large = pos_first_late[((pos_first_late['SK_DPD_DEF'] >= 60) & (pos_first_late['SK_DPD_DEF'] <= 90))].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})

    pos_first_late_90 = pos_first_late[(pos_first_late['SK_DPD'] > 90)  | (pos_first_late['SK_DPD_DEF'] > 90) ].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})
    pos_first_late_90_large = pos_first_late[pos_first_late['SK_DPD_DEF'] > 90].sort_values(['SK_ID_PREV', 'MONTHS_BALANCE']).groupby(['SK_ID_PREV', 'SK_ID_CURR']).agg({'MONTHS_BALANCE': ['min']})
    ...
    pos_first_late_30.columns = pd.Index(['FIRST_INSTALMENT_LATE_30'])
    pos_first_late_30_large.columns = pd.Index(['FIRST_INSTALMENT_LATE_DEF_30'])
    pos_first_late_60.columns = pd.Index(['FIRST_INSTALMENT_LATE_60'])
    pos_first_late_60_large.columns = pd.Index(['FIRST_INSTALMENT_LATE_DEF_60'])
    pos_first_late_90.columns = pd.Index(['FIRST_INSTALMENT_LATE_90'])
    pos_first_late_90_large.columns = pd.Index(['FIRST_INSTALMENT_LATE_DEF_90'])
    ...
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_30, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_30_large, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_60, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_60_large, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_90, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')
    POS_CASH_balance = POS_CASH_balance.merge(pos_first_late_90_large, on=['SK_ID_PREV', 'SK_ID_CURR'], how = 'left')

    del pos_first_late_month
    del pos_first_late_month_large
    del pos_first_late_30
    del pos_first_late_30_large
    del pos_first_late_60
    del pos_first_late_60_large
    del pos_first_late_90
    del pos_first_late_90_large
    ...
    POS_CASH_balance['FIRST_INSTALMENT_LATE_30_PER_LOAN_TERM'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_30']*100)/POS_CASH_balance['LOAN_TERM']
    POS_CASH_balance['FIRST_INSTALMENT_LATE_30_PER_LOAN_TERM_DEF'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_DEF_30']*100)/POS_CASH_balance['LOAN_TERM']
    POS_CASH_balance['FIRST_INSTALMENT_LATE_60_PER_LOAN_TERM'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_60']*100)/POS_CASH_balance['LOAN_TERM']
    POS_CASH_balance['FIRST_INSTALMENT_LATE_60_PER_LOAN_TERM_DEF'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_DEF_60']*100)/POS_CASH_balance['LOAN_TERM']
    POS_CASH_balance['FIRST_INSTALMENT_LATE_90_PER_LOAN_TERM'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_90']*100)/POS_CASH_balance['LOAN_TERM']
    POS_CASH_balance['FIRST_INSTALMENT_LATE_90_PER_LOAN_TERM_DEF'] = (POS_CASH_balance['FIRST_INSTALMENT_LATE_DEF_90']*100)/POS_CASH_balance['LOAN_TERM']
...
def prev_app(df):
    ...
    num_aggregations = {
        ...
        'AMT_APPLICATION_NORM': ['min', 'max', 'mean'],
        'AMT_CREDIT_NORM': ['min', 'max', 'mean'],
        'AMT_DOWN_PAYMENT_NORM': ['min', 'max', 'mean'],
        'AMT_GOODS_PRICE_PAYMENT_NORM': ['min', 'max', 'mean'],
        'AMT_ANNUITY_PAYMENT_NORM': ['min', 'max', 'mean'],
...
def remove_on_missing(df):
    ...
    missing_list = ['NEW_RATIO_BURO_CNT_CREDIT_PROLONG_SUM', 'NEW_RATIO_BURO_CREDIT_TYPE_Mortgage_MEAN',
                    ...
                    'NEW_RATIO_BURO_DAYS_ENDDATE_FACT_MEAN']
...
def remove_on_importance(df, remove_by_threshold = False, remove_by_rank = False):
    ...
    importance = pd.read_csv('../output/importance_3.5.csv')
...
def main(
    ...
    if importance_prune == True:
        with timer("Post-processing"):
            df = remove_on_importance(df, remove_by_threshold = False, remove_by_rank = True)
            print("df shape:", df.shape)
    if split_data == True:
    ...
    df.to_csv('../data/processed_data_3.5_pruned.csv', compression = 'zip')  
